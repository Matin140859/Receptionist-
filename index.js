...
app.post("/voice", async (req, res) => {
  try {
    ...
    let replyText = "let replyText = "Willkommen bei Apex Plumbing! Ich bin Ihr KI-Assistent. Bitte nennen Sie mir kurz Ihren Namen, Ihr Grund legendes Anliegen und Ihre Rueckrufnummer, dann leite ich alles direkt weiter.";
    if (userSpeech) {
